function addSlide(slideIndex) {
    if (slideIndex === 0) {
        $('#course-carousel').append(`<div class='carousel-item active' id='${slideIndex}'><div class='row'></div></div>`);
    } else {
        $('#course-carousel').append(`<div class='carousel-item' id='${slideIndex}'><div class='row'></div></div>`);
    }
}

function addCourse(slideIndex, course, ratingPoint, isBestseller) {
    $(`#${slideIndex}`).find('.row').append(
        `
        <div class='col-lg-4 col-sm-6 mb-5'>
            <div class='card mb-2 border-primary rounded-0 hover-shadow' id='${course.idCourse}'>
            ...
            ${ isBestseller ? "<div class='card-footer mt-2'>Bestseller</div>" : ''}
        </div>
        `
    );
}
...
$(document).ready(function() {
    ...
    courses.map(course => {
        ...
        if (numberOfCourses % 3 === 0) {
            ++numberOfSlides;
            addSlide(numberOfSlides);
        }

        addCourse(numberOfSlides, course, ratingPoint.toFixed(2), isBestseller);
